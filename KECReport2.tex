...
\begin{center}
	...
	\caption[Architecture of Alexnet]{\centering Architecture of Alexnet \\Source: \textit{https://medium.com/analytics-vidhya/concept-of-alexnet-convolutional-neural-network-6e73b4f9ee30}} %figure name
...
\begin{figure}
\begin{center}
\includegraphics[width=3in]{images/y16.jpg}
\caption[MRI image with tumor]{ \centering MRI image with tumor
\end{center}
\end{figure}
\newpage
\begin{description}
